...
public class AddressInputCommand extends AbstractCommand
{
	private final Extractor<Address> extractor;
	private final CartService cartService;
	private final SessionService sessionService;

	public AddressInputCommand()
	{
	...
	public void process() throws ServletException, IOException
	{
		...
		final Cart cart = cartService.confirmOrder(customer, address);
		servletContext.setAttribute(ApplicationConstant.CART, cart);
		response.sendRedirect(ApplicationConstant.CONFIRMATION_PATH);
	}
}
